...
$update_accountPassword_hashed = password_hash($password, PASSWORD_DEFAULT);
...
$sql = "UPDATE members
        ...
        SET members.precinct = ?,
            ...
            member_emergency.contact_name = ?,
            member_account.username = ?,
            member_account.password = ?  -- Add this line for contact_name
        WHERE members.member_id = ?";

$stmt = $db->prepare($sql);

if ($stmt) {
    $stmt->bind_param("sssssssssssssssssssi", $precinct, $changeprofilepic, $fullname, $firstname, $middlename, $lastname, $surfix, $birth_date, $civil_status, $campus_id, $inputAddress, $religion, $cellphone_no, $residency, $yrs_res, $cellphone_no, $contact_name, $username, $update_accountPassword_hashed, $editmember_id); // Modify bind_param to include contact_name
