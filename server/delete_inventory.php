...
if ($preparedSql = $db->prepare("DELETE FROM `barangay_inventory` WHERE `id` = ?")) {
    ...
    if ($preparedSql->execute()) {
        ...
        $response['description'] = "Barangay Inventory: <b>AN" . $id . "</b> have been deleted at <b>Barangay Inventory.</b>";
    } else {
