  ...
  if ($preparedSql = $db->prepare("UPDATE `request_busclearance` SET `status`= ? WHERE id =? ")) {
  ...
  <div style='text-align: center;'>
      ...
      <h1 style='margin-top:5px;'><u>Certificate Business Clearance</u></h1>
</div>
    ...
    $pdf->Output($tempFileName, 'F');
      ...
      $mail = new PHPMailer(true);
          ...
          $mail->Port = 465;
              ...
              // Attach the PDF
              $mail->addAttachment($tempFileName, 'Barangay Business Clearance.pdf');


          $mail->setFrom('barangay020@gmail.com');
        
          $mail->addAddress($email); // Replace with your actual email address
          $mail->Subject = 'Barangay Business Clearance';
