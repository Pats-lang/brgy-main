  ...
  if ($preparedSql = $db->prepare("UPDATE `request_brgyid` SET `status`= ? WHERE id =? ")) {
  ...
  <div style='text-align: center;'>
      ...
      <h1 style='margin-top:5px;'><u>Certificate of Barangay ID</u></h1>
</div>
