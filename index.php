            ...
            <div class="carousel-inner">
                ...
                <div class="carousel-item <?php echo $itemClass; ?>">
                    <div class="position-relative">
                        <img src="assets/images/announcement/<?php echo $row['img']; ?>" class="img-fluid d-block"
                            style="width:100%; height:1000px;" alt="Image">
                    ...
                    <div class="col-xl-7 icon-boxes">
                        <div class="row gy-4  mt-5">
                            ...
                            <div class="col-md-6 mt-5" data-aos="fade-up" data-aos-delay="200">
                                <div class="icon-box ">
                                    <h3>Lost some Item?</h3>
                                    <p>Click here to assist you!</p>
                                    <button type="button" class="button mt-4" data-toggle="modal"
                ...
                <div class="modal-body">
                    ...
                    <form id="lost-form">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="alumniId" name="alumniID"
