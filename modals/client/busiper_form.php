                        ...
                        <div class="p-2 breadcrumb-container">
                            <div class="d-flex justify-content-between align-items-center mt-2 flex-wrap">
                                ...
                                <div class="d-flex flex-wrap align-items-center">
                                    ...
                                    <span class="mx-1">/</span>
                                    <a href="" class="text-reset" style="text-decoration:none;">Business Permit</a>
                                </div>
    ...
    <div class="col-4">
        <div data-mdb-input-init class="form-outline">
            ...
            <div class="row mb-4">
                ...
                <div class="col">
                    <div data-mdb-input-init class="form-outline">
                        <input type="text" id="request" class="form-control" value="Business Permit" readonly style="background-color: #f2f2f2;"/>
