...
<body class="hold-transition sidebar-mini layout-fixed">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item text-secondary">Projects</li>
                            </ol>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <div class="card card-primary">
                                <div class="card-body">
                                    <table id="manageClient_projectsTable" class="table responsive">
                                        <thead>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr id="<?php echo $row['id']; ?>">
                                                    <td>
                                                        <img src="../assets/images/projects/<?php echo $row['img']; ?>" alt="Project Picture" width="200">
                                                    </td>
                                                    <td>
                                                        <?php echo $row['title']; ?>
                                                    </td>
            ...
            <div class="modal-content">
                <form id="addAnnouncementForm" enctype="multipart/form-data">
                    ...
                    <div class="modal-header">
                        <h1 class="modal-title fs-5">Add Projects</h1>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <form id="viewAnnouncementForm">
                    ...
                    <div class="modal-header">
                        <h1 class="modal-title fs-5">View Projects</h1>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <form id="editAnnouncementForm" enctype="multipart/form-data">
                    ...
                    <div class="modal-header">
                        <h1 class="modal-title fs-5">Edit Projects</h1>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
    ...
    <script>
        $(document).ready(function() {
            $('#manageClient_projectsTable').DataTable({
                buttons: [{
                        extend: 'copy',
        ...
        $(document).on('click', 'button[data-role=viewAnnouncement_btn]', function() {
            $.ajax({
                type: "POST",
                url: "../server/read_projects.php",
                data: {
                    id: $(this).attr('data-id'),
                },
                dataType: "json",
                success: function(response_viewAnnouncement) {
                    $('#view_ImageAnnouncements').attr('src', '../assets/images/projects/' + response_viewAnnouncement.img);
        ...
        $(document).on('click', 'button[data-role=editAnnouncement_btn]', function() {
            $.ajax({
                ...
                dataType: "json",
                success: function(response_editAnnouncement) {
                    $('#editPreview_ImageAnnouncements').attr('src', '../assets/images/projects/' + response_editAnnouncement.img);
        ...
        $(document).on('click', 'button[data-role=deleteAnnouncement_btn]', function(e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        type: "POST",
                        url: "../server/delete_projects.php",
                        data: {
                            id: $(this).attr('data-id'),
                        },
                        dataType: "json",
