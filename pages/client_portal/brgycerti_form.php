...
<body class="index-page" data-bs-spy="scroll" data-bs-target="#navmenu">
    ...
    <form id="request_barangay-certform" method="post" class="p-5 rounded border" style="background-color: #ADE8F4; box-shadow: 0px 1px 10px rgba(0, 0, 255, 0.4);
            ...
            <div class="row mb-4">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="request" id="request" class="form-control" value="Barangay Certificate" readonly>
                    </div>
                </div>
            </div>
