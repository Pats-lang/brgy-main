                                ...
                                <form id="editAnnouncementForm">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" id="i_message" name="i_message" rows="5" readonly></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label for="message1">Reply to Inquiry</label>
                                            <textarea class="form-control" id="r_message" name="r_message" rows="5"></textarea>
                                        </div>
                                        </textarea>
                                    </div>
