...
<link rel="icon" href="../../assets/images/logo/barangay.gif"/>
<!-- Navbar -->
<nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
        ...
        <li class="nav-item d-none d-sm-inline-block">
            <a href="dashboard.php" class="nav-link">Welcome to Baranggay Management System</a>
        </li>
    </ul>
...
<aside class="main-sidebar main-sidebar-custom sidebar-light-primary elevation-4">
    ...
    <a href="dashboard.php" class="brand-link text-decoration-none">
        ...
        <span class="brand-text font-weight-bold">Barangay System</span>
    </a>
    ...
    <div class="sidebar-custom border-0">
        ...
        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
            ...
            <a type="button" class="dropdown-item" href="../server/logout.php">Log-out</a>
        </div>
        <!-- /.sidebar-custom -->
    </div>
