                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item text-secondary">Request Baranggay Id</li>
                            </ol>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="card-body">
                                    <table id="manageClient_inquiriesTable" class="table responsive">
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            $query = "SELECT * FROM `request_brgyid` ";
                        ...
                        <div class="col-md-12">
                            ...
                            <form id="editAnnouncementForm">
                                <div class="card-body">
                                    ...
                                    <div class="row mt-4">
                                        <div class="col-md-4">
                                            <label for="register_address">Birth Of Date</label>
                                            <input type="text" class="form-control form-control-border" id="register_birth" name="register_birth" placeholder="Type your Address" readonly>
                                        </div>
                                        <div class="col-md-4">
                                    ...
                                    <div class="row mt-4">
                                        <div class="col-md-4">
                                            ...
                                            <textarea type="text" class="form-control form-control-border" id="register_civil" name="register_civil" placeholder="Type your Birthday" readonly>
                                                </textarea>
                                        </div>
                                        <div class="col-md-4">
                                            <label for="register_contact">Precint No.</label>
                                            <textarea type="text" class="form-control form-control-border" id="register_precint" name="register_precint" placeholder="Type your Contact" readonly>
                                                </textarea>
                                        </div>
                                        <div class="col-md-4">
        ...
        $('#editAnnouncementForm').on('submit', function(e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "../server/edit_brgy_rqst_id.php",
                        type: "POST",
