...
<body class="hold-transition sidebar-mini layout-fixed">
        ...
        <div class="content-wrapper">
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1>Request Barangay Indigency</h1>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item text-secondary">Request Barangay Indigency</li>
                            </ol>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="card-body">
                                    <table id="manageClient_inquiriesTable" class="table responsive">
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            $query = "SELECT * FROM `request_brgycoi` ";
    ...
    function sendSMS(name, status, num) {
        ...
        if (status == 2) {
            message =
                `Magandang araw, ${name}!Nais naming ipaalam sa inyo na maaari na pong kunin ang inyong Barangay Indigency sa tanggapan ng ating Barangay.Maraming salamat po.`;
        } else if (status == 1) {
            message =
            `Magandang araw, ${name}!Nais naming ipaalam sa inyo na hindi approbado ang inyong Barangay Indigency sa tanggapan ng ating Barangay.Maraming salamat po.`;
