...
<body class="hold-transition sidebar-mini layout-fixed">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item text-secondary">Announcements</li>
                            </ol>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <div class="card card-primary">
                                <div class="card-body">
                                    <table id="manageClient_announcementsTable" class="table responsive">
                                        <thead>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr id="<?php echo $row['id']; ?>">
                                                    <td>AN<?php echo $row['id']; ?>
                                                    </td>
                                                    <td>
                                                        <img src="../assets/images/announcement/<?php echo $row['img']; ?>" alt="Member Picture" width="200">
                                                    </td>
                                                    <td>
                                                        <?php echo $row['title']; ?>
                                                    </td>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <form id="viewAnnouncementForm">
                    ...
                    <div class="modal-header">
                        <h1 class="modal-title fs-5">View Announcement</h1>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row py-1">
                            <div class="col">
                                ...
                                <input type="text" class="form-control form-control-border" id="view_titleAnnouncements" name="view_titleAnnouncements" placeholder="Title" readonly>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" class="form-control form-control-border" id="view_lastModifiedAnnouncements" name="view_lastModifiedAnnouncements" readonly>
                            </div>
                        </div>
            ...
            <div class="modal-content">
                <form id="editAnnouncementForm" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row py-1">
                            <div class="col">
                                <label for="edit_titleAnnouncements">Title</label>
                                <input type="text" class="form-control form-control-border" id="edit_titleAnnouncements" name="edit_titleAnnouncements" placeholder="Title">
                            </div>
                        </div>

                        <div class="row py-1">
                            <div class="col">
                                <label for="edit_descriptionAnnouncements">Description</label>
                                <textarea class="form-control form-control-border" id="edit_descriptionAnnouncements" name="edit_descriptionAnnouncements" style="height: 125px; resize: none;" placeholder="Description"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" class="form-control form-control-border" id="edit_lastModifiedAnnouncements" name="edit_lastModifiedAnnouncements" readonly>
                            </div>
                        </div>
    ...
    <script>
        $(document).ready(function() {
            $('#manageClient_announcementsTable').DataTable({
                buttons: [{
                        extend: 'copy',
    ...
    $('#addAnnouncementForm').on('submit', function(e) {
        ...
        $.ajax({
            type: 'POST',
            url: '../server/add_client-announcement.php',
        ...
        $('#editAnnouncementForm').on('submit', function(e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "../server/edit_client-announcement.php",
                        type: "POST",
                        data: new FormData(this),
                        dataType: 'json',
                        processData: false,
        ...
        $(document).on('click', 'button[data-role=viewAnnouncement_btn]', function() {
            $.ajax({
                type: "POST",
                url: "../server/read_client-announcement.php",
                data: {
                    id: $(this).attr('data-id'),
                },
                dataType: "json",
                success: function(response_viewAnnouncement) {
                    $('#view_ImageAnnouncements').attr('src', '../assets/images/announcement/' + response_viewAnnouncement.img);
                    $('#view_titleAnnouncements').val(response_viewAnnouncement.title);
                    $('#view_descriptionAnnouncements').val(response_viewAnnouncement.description);
                    $('#view_lastModifiedAnnouncements').val(response_viewAnnouncement.last_modified);
                }
            })
        ...
        $(document).on('click', 'button[data-role=editAnnouncement_btn]', function() {
            $.ajax({
                ...
                dataType: "json",
                success: function(response_editAnnouncement) {
                    $('#editPreview_ImageAnnouncements').attr('src', '../assets/images/announcement/' + response_editAnnouncement.img);
                    $('#edit_IdAnnouncements').val(response_editAnnouncement.id);
                    $('#edit_titleAnnouncements').val(response_editAnnouncement.title);
                    $('#edit_descriptionAnnouncements').val(response_editAnnouncement.description);
        ...
        $(document).on('click', 'button[data-role=deleteAnnouncement_btn]', function(e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        type: "POST",
                        url: "../server/delete_client-announcement.php",
                        data: {
                            id: $(this).attr('data-id'),
                        },
                        dataType: "json",
