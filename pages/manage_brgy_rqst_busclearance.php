                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row mt-4">
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control form-control-border" id="business_name" name="business_name" placeholder="Business Name" readonly>
                                        </div>
                                        <div class="col-md-6">
                                            <label for="register_first_name">Owners Name</label>
                                            <input type="text" class="form-control form-control-border" id="register_name" name="name" placeholder="Owners Name" readonly>
                                        </div>

                                        <div class="col-md-6">
                                            <label for="register_contact">Kind Of Business</label>
                                            <textarea type="text" class="form-control form-control-border" id="kof" name="kof" placeholder="Kind of Business" readonly>
                                                </textarea>
                                        </div>
                                    ...
                                    <div class="row mt-4">
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" class="form-control form-control-border" id="register_yrsres" name="register_Residency" placeholder="Type your Address" readonly>
                                        </div>
                                        <div class="col-md-4">
