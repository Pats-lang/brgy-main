...
<body class="hold-transition sidebar-mini layout-fixed">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row mt-4">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <textarea type="text" class="form-control form-control-border" id="kof"
                                                name="kof" placeholder="Kind of Business" readonly>
                                                </textarea>
                                        </div>
                                    ...
                                    <div class="row mt-4">
                                        <div class="col-md-6">
                                            ...
                                            <textarea type="text" class="form-control form-control-border"
                                                ...
                                                placeholder="Type your purpose" readonly>
                                                </textarea>
                                        </div>
                                        <div class="col-md-6">
    ...
    $('#editAnnouncementForm').on('submit', function(e) {
        ...
        if (status == 2) {
            message =
                `Magandang araw, ${name}!Nais naming ipaalam sa inyo na maaari na pong kunin ang Business Clearance sa tanggapan ng ating Barangay.Maraming salamat po.`;
        } else if (status == 1) {
            message =
            `Magandang araw, ${name}!Nais naming ipaalam sa inyo na hindi approbado ang inyong Business Clearance sa tanggapan ng ating Barangay.Maraming salamat po.`;
    ...
    $(document).on('click', 'button[data-role=editAnnouncement_btn]', function() {
        $.ajax({
            ...
            success: function(response_editAnnouncement) {
                ...
                $('#business_name').val(response_editAnnouncement
                .business_name); // Corrected property name
