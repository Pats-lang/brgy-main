...
<body class="index-page" data-bs-spy="scroll" data-bs-target="#navmenu">
    ...
    <section>
        ...
        <div class="row mt-5 g-3">
            <div class="col-12 col-md-3 mx-auto text-center" data-aos="fade-up" data-aos-delay="300" data-aos-duration="00" data-aos-easing="ease-out">
                <div class="box border mb-4 mem d-flex flex-column h-100">
                    <?php
        ...
        <div class="container ">
            <div class="row mt-5 g-3 text-center">
                ...
                <div class="col-md-3 text-center " data-aos="fade-up" data-aos-delay="300">
                    <div class="box border mb-4 mem d-flex flex-column h-100" style="width: 100%;">
                        <?php
                        $positionToDisplay = "Barangay Kagawad";  // Specify the position you want to display
                        $id = '6';
