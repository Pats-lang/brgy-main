...
<body>
                ...
                <div class="details personal">
                    ...
                    <div class="fields">
                        ...
                        <div class="input-field">
                            ...
                            <input type="text" name="precinct_number" id="precinct_number"
                                placeholder="Enter Precinct Number" required>
                        </div>
                    </div>
                </div>
    ...
    $('#barangay_register').on('submit', function(e) {
        ...
        if ($('#barangay_register').valid()) {
            Swal.fire({
                title: 'Can you confirm the accuracy of the information?',
                            ...
                            $.ajax({
                                ...
                                success: function(response_Editrequest) {
                                    if (response_Editrequest.status) {
                                        toastr.success(response_Editrequest
                                            .message,
                                        ...
                                        toastr.error(response_Editrequest
                                            .message, '', {
                                                closeButton: false,
                                            });
                                    }
