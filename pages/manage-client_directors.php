                                            ...
                                            ?>
                                                <tr id="<?php echo $row['id']; ?>">
                                                    <td>
                                                        ...
                                                        <img src="../assets/images/officials/<?php echo $row['img_officials']; ?>" alt="Member Picture" width="200">
                                                    </td>
                                                    <td>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row py-1">
                            <div class="col">
                                ...
                                <input type="text" class="form-control form-control-border" id="view_descriptionAnnouncements" name="view_descriptionAnnouncements" readonly></textarea>
                            </div>
                        </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row py-1">
                            <div class="col">
                                ...
                                <select class="form-control" id="edit_descriptionAnnouncements" name="edit_descriptionAnnouncements">
